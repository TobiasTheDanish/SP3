...
public class StartMenu {
    ...
    public static User logIn(IDataIO dataIO) {
       ...
       currentUsername = currentUsername.trim();
         ...
         */
        if(existingUsername(currentUsername,dataIO)) {
            String input;
           ...
           if(correctPassword(currentPassword,dataIO)) {
               ...
               return new User(currentUsername, currentPassword,dataIO);
           } else {
               while (!correctPassword(currentPassword,dataIO)) {
                   do {
        ...
        //If the users input for username doesn't match any usernames from the userdata.csv, it will give you following options.
        else if(!existingUsername(currentUsername,dataIO)) {
            ...
            do {
                ...
                if (input.equalsIgnoreCase("T")) {
                    ...
                    User user = new User(currentUsername, currentPassword,dataIO);
                    /*
